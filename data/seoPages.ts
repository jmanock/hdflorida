...
export const seoLandingPages: SeoLandingPage[] = [
  ...
  },
  {
    ...
    details:
      "Beach resort pricing can move quickly with weather, holidays, and events. This page collects useful coastal hotel searches across Florida so visitors can compare current stay options. Compare Gulf Coast and Atlantic Coast beach destinations based on travel style, beach access, nightlife, and family activities. Review Miami Beach, Fort Lauderdale, Clearwater Beach, Sarasota, Daytona Beach, Naples, and Florida Keys resort areas before choosing a destination. Compare hotel location, resort fees, parking, beach access, and seasonal demand before booking.",
    image: "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?auto=format&fit=crop&w=1400&q=85",
